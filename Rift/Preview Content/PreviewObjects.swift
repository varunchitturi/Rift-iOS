...
struct PreviewObjects {
    ...
    static let assignment = Assignment(id: 1, isActive: true, name: "Find a frog", dueDate: Date() + 2, assignedDate: Date(), courseName: "How to cook frogs", totalPoints: 100, scorePoints: 90, comments: nil, multiplier: 1, categoryName: "Unit Test")
