...
struct PreviewObjects {
    ...
    static let grade = Grade(letterGrade: "A", percentage: 90, currentPoints: 90, totalPoints: 100, termName: "Q1", termType: "Quarter", groupWeighted: false, hasInitialAssignments: true, hasCompositeTasks: false, cumulativeTermName: nil)
    ...
    static let gradingCategory = GradingCategory(id: 4, name: "Judgement", isWeighted: true, weight: 100, isExcluded: false, assignments: [assignment])
