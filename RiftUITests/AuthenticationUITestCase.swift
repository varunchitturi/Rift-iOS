//
//  AuthenticationUITestCase.swift
//  RiftUITests
//
...
class AuthenticationUITestCase: XCTestCase {
    ...
    func getAccountFromEnvironment(accountType: LogInMethod, index: Int? = nil) -> Account? {
    ...
    func simulateAuthenticationFlow(_ app: XCUIApplication, account: Account) {
    ...
    func chooseLocale(_ app: XCUIApplication, account: Account) {
    ...
    func googleSSOLogin(_ app: XCUIApplication, account: Account) {
    ...
    /// - Note: You must be in the `LogInView`
    func credentialLogin(_ app: XCUIApplication, account: Account) {
    ...
    func logOutWithPersistenceCheck(_ app: XCUIApplication) {
